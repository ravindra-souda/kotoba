 ...
 * @coversNothing
 *
 * @phpstan-import-type NounType from Types
 * @phpstan-import-type NounExpectedType from Types
 */
class NounsPostTest extends ApiTestCase
{
    ...
    /**
     * @return array<string,list<NounType>>
     */
     ...
     *
     * @param NounType         $payload
     * @param NounExpectedType $expected
     */
    ...
    /**
     * @return array<string,array<NounType|string>>
     */
