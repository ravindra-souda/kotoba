 ...
 * @coversNothing
 *
 * @phpstan-import-type KanaType from Types
 * @phpstan-import-type KanaExpectedType from Types
 */
class KanaPostTest extends ApiTestCase
{
    ...
    /**
     * @return array<string,list<KanaType>>
     */
     ...
     *
     * @param KanaType         $payload
     * @param KanaExpectedType $expected
     */
    ...
    /**
     * @return array<string,array<KanaType|string>>
     */
