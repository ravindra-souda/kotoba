...
class KanjiGetTest extends ApiTestCase
{
    ...
    /**
     * @return array<string,array<string,list<KanjiType>|string>>
     */
    ...
    public function testKanjiGetPagination(): void
    {
        ...
        $this->assertJsonContains([
            ...
            'hydra:view' => [
                ...
                'hydra:first' => '/api/cards/kanji?onyomi='.
                    urlencode('タイ').'&page=1',
                'hydra:last' => '/api/cards/kanji?onyomi='.
                    urlencode('タイ').'&page='.$lastPage,
                'hydra:next' => '/api/cards/kanji?onyomi='.
                    urlencode('タイ').'&page=2',
            ],
        ]);
