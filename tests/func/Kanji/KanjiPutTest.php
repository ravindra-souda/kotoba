 ...
 * @coversNothing
 *
 * @phpstan-import-type KanjiType from Types
 */
class KanjiPutTest extends ApiTestCase
{
    ...
    /**
     * @return array<string,array<KanjiType|string>>
     */
    public function validKanjiProvider(): array
    {
        ...
        foreach (self::PUT_VALID_KANJI as $key => $payload) {
            ...
            /** @var KanjiType $payload */
            $payload = array_merge(
                $fixture,
                self::PUT_VALID_KANJI[$key]
            );

            /** @var KanjiType $expected */
     ...
     *
     * @param KanjiType $fixture
     * @param KanjiType $payload
     * @param KanjiType $expected
     */
