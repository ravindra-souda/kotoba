 ...
 * @coversNothing
 *
 * @phpstan-import-type VerbType from Types
 * @phpstan-import-type VerbExpectedType from Types
 */
class VerbsPostTest extends ApiTestCase
{
    ...
    /**
     * @return array<string,list<VerbType>>
     */
     ...
     *
     * @param VerbType         $payload
     * @param VerbExpectedType $expected
     */
    ...
    /**
     * @return array<string,array<string|VerbType>>
     */
