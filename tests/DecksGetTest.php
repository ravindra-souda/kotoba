...
class DecksGetTest extends ApiTestCase
{
    ...
    /**
     * @return array<string,array{url:string,expected:DeckType}>
     */
    ...
    /**
     * @return array<string,array{url:string,expected:list<DeckType>}>
     */
    ...
    /**
     * @return array{field:list<string>,enum:list<string>}
     */
